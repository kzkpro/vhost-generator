 ...
 *   https://datatables.net/download/#bs5/dt-1.11.3/b-2.0.1/fc-4.0.1/fh-3.2.0/r-2.2.9/rg-1.1.4/sc-2.0.5
 *
 * Included libraries:
 *   DataTables 1.11.3, Buttons 2.0.1, FixedColumns 4.0.1, FixedHeader 3.2.0, Responsive 2.2.9, RowGroup 1.1.4, Scroller 2.0.5
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.11.3/b-2.0.1/fc-4.0.1/fh-3.2.0/r-2.2.9/rg-1.1.4/sc-2.0.5",
